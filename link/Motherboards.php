...
// Fetch motherboards from DB
$stmt = $pdo->prepare("SELECT * FROM products WHERE category = 'motherboard' AND in_stock = 1 ORDER BY created_at DESC");
$stmt->execute();
$motherboardProducts = $stmt->fetchAll();
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>TechNova | Motherboards</title>
    <link rel="stylesheet" href="Motherboards.css">
    <link
...
<body>
    ...
    <section class="bottom-features" style="margin-top: 40px;">
        <div class="feature-col popup-list-col sticky">
            ...
            <div class="popup-item" onclick="window.location.href='graphic.php'" style="cursor: pointer;">Graphic Card
            </div>
            <div class="popup-item active" onclick="window.location.href='Motherboards.php'" style="cursor: pointer;">
                Motherboards</div>
            <div class="popup-item" onclick="window.location.href='phone.php'" style="cursor: pointer;">Mobile Phone
            </div>
        ...
        <div class="right-column" style="display: flex; flex-direction: column; gap: 40px; flex-grow: 1;">
            <div class="product-grid">
                <?php if ($motherboardProducts): ?>
                    <?php foreach ($motherboardProducts as $product): ?>
                    <div class="product-item">
                        <div class="product-image-wrapper">
                            <img src="../<?php echo htmlspecialchars($product['image']); ?>"
                                alt="<?php echo htmlspecialchars($product['title']); ?>" onerror="this.src='https://via.placeholder.com/300?text=Motherboard'">
                ...
                <?php else: ?>
                    <div style="grid-column: 1 / -1; text-align: center; padding: 50px; color: var(--text-color);">
                        <h2>No Motherboards Found</h2>
                        <p>Get ready for more hardware!</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
