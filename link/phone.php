...
// Fetch phones from DB
$stmt = $pdo->prepare("SELECT * FROM products WHERE category = 'phone' AND in_stock = 1 ORDER BY created_at DESC");
$stmt->execute();
$phoneProducts = $stmt->fetchAll();
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>TechNova | Mobile Phone</title>
...
<body>
    ...
    <section class="bottom-features" style="margin-top: 40px;">
        <div class="feature-col popup-list-col sticky">
            ...
            <div class="popup-item" onclick="window.location.href='graphic.php'" style="cursor: pointer;">
                Graphic Card</div>
            <div class="popup-item" onclick="window.location.href='Motherboards.php'" style="cursor: pointer;">
                Motherboards</div>
            <div class="popup-item">Monitors</div>
            <div class="popup-item active" style="cursor: pointer;">Mobile Phone</div>
        ...
        <div class="right-column" style="display: flex; flex-direction: column; gap: 40px; flex-grow: 1;">
            <div class="product-grid">
                <?php if ($phoneProducts): ?>
                    <?php foreach ($phoneProducts as $product): ?>
                    <div class="product-item">
                        <div class="product-image-wrapper">
                            <img src="../<?php echo htmlspecialchars($product['image']); ?>"
                                alt="<?php echo htmlspecialchars($product['title']); ?>" onerror="this.src='https://via.placeholder.com/300?text=Phone'">
    ...
    <script src="link-shared.js"></script>
