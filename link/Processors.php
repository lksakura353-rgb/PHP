...
// Fetch processors from DB
$stmt = $pdo->prepare("SELECT * FROM products WHERE category = 'processor' AND in_stock = 1 ORDER BY created_at DESC");
$stmt->execute();
$processorProducts = $stmt->fetchAll();
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>TechNova | Processors</title>
...
<body>
    ...
    <section class="bottom-features" style="margin-top: 40px;">
        <div class="feature-col popup-list-col sticky">
            <div class="popup-item active" onclick="window.location.href='Processors.php'" style="cursor: pointer;">
                Processors</div>
        ...
        <div class="right-column" style="display: flex; flex-direction: column; gap: 40px; flex-grow: 1;">
            <div class="product-grid">
                <?php if ($processorProducts): ?>
                    <?php foreach ($processorProducts as $product): ?>
                    <div class="product-item">
                        <div class="product-image-wrapper">
                            <img src="../<?php echo htmlspecialchars($product['image']); ?>"
                                alt="<?php echo htmlspecialchars($product['title']); ?>" onerror="this.src='https://via.placeholder.com/300?text=Processor'">
